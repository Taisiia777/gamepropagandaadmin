...
//         axios.get('https://455b-95-161-221-131.ngrok-free.app/mailing')
...
//         axios.post('https://455b-95-161-221-131.ngrok-free.app/mailing', { description, type, trigger, imageUrl, url })
//             .then(response => {
...
//         // Отправка рассылки
//         axios.post(`https://455b-95-161-221-131.ngrok-free.app/mailing/send/${id}`)
//             .then(() => {
